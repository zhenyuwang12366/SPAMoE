...
deepspeed --num_gpus=2 scripts/deepspeed_seismic_moe.py \
  --setting_path /data1/home/teacher/teacher_s/t108790/results/fourier_0/seismic_moe_curve_vel_b/FNO_router-basic_lr0.000267116_bs32_fourier_0_20251027-133412 \
