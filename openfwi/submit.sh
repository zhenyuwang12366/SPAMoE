...
torchrun --standalone \
  ...
  /data1/home/teacher/teacher_s/t108790/OpenFWI/train.py \
    -ds curvevel-b \
    -fs 500 \
    -t /data1/home/teacher/teacher_s/t108790/OpenFWI/split_files_local_full/curvevel_b_train.txt \
    -v /data1/home/teacher/teacher_s/t108790/OpenFWI/split_files_local_full/curvevel_b_val.txt \
    -m InversionNet \
    -g2v 0 \
    -n ../results/seismic_moe_${SLURM_JOB_NAME}_${SLURM_JOB_ID} \
    --tensorboard \
    --sync-bn \
    --world-size 2 \
    --dist-url env://